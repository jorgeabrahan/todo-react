...
```
git clone https://github.com/jorgeabrahan/todo_react.git
```
...
To run the project, if you are on the todo_react folder path on your terminal you can execute the following command:
